...
public class StrengthSpellScreen extends Screen {
    ...
    private static final ResourceLocation STRENGTH_RUNE = new ResourceLocation(XadianMagic.MOD_ID,
            "textures/gui/entries/strength_rune.png");

    public StrengthSpellScreen(Component pTitle) {
        super(pTitle);
    }
    ...
    public boolean keyPressed(int pKeyCode, int pScanCode, int pModifiers) {
        if(pKeyCode == 66) {
            ModPackets.sendToServer(new StrengthSpellC2SPacket());
            return true;
    ...
    public void render(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        graphics.drawString(Minecraft.getInstance().font, Component.literal("This spell gives the"),
                324, 87, 0, false);
        graphics.drawString(Minecraft.getInstance().font, Component.literal("user a short burst of"),
                324, 98, 0, false);
        graphics.drawString(Minecraft.getInstance().font, Component.literal("strength."),
                324, 109, 0, false);

        graphics.blit(STRENGTH_RUNE, x - 120, y - 200, 0, 0, 100, 50,
                100, 50);
