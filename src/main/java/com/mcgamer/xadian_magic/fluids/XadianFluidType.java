package com.mcgamer.xadian_magic.fluids;
...
public class XadianFluidType extends FluidType {
    ...
    public XadianFluidType(Properties properties, FluidInfo info) {
        super(properties);
        RENDER_OVERLAY = new ResourceLocation(XadianMagic.MOD_ID, "textures/overlay/" + info.name + ".png");
        TEXTURE_STILL = new ResourceLocation(XadianMagic.MOD_ID, "block/fluid/" + info.name + "_still");
        TEXTURE_FLOW = new ResourceLocation(XadianMagic.MOD_ID, "block/fluid/" + info.name + "_flow");
        TEXTURE_OVERLAY = new ResourceLocation(XadianMagic.MOD_ID, "block/fluid/" + info.name + "_overlay");
